...
export function RainbowBanner({ text }: RainbowBannerProps) {
  ...
  return (
    <div className="mx-auto mb-4 w-full max-w-3xl">
      <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-gradient-to-r from-pink-50/80 via-white/70 to-purple-50/80 px-4 py-3 text-center shadow-[0_6px_22px_rgba(214,106,139,0.18)]">
